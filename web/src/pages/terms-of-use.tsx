...
const TermsOfUse: React.FC<{}> = ({}) => {
  return (
    <>
      <Heading my={2} fontSize="20px">Website Terms of Use</Heading>

      <Text my={2}>Version 1.0</Text>

      <Text my={2}>
        The Schoolyard website located at GoSchoolyard.com is a copyrighted work
        belonging to GoSchoolyard.com. Certain features of the Site may be
      ...
      <Heading my={2} fontSize="20px">Access to the Site</Heading>
      ...
      <Heading my={2} fontSize="20px">User Content</Heading>
      ...
      <Heading my={2} fontSize="20px">Third-Party Links & Ads; Other Users</Heading>
      ...
      <Text my={2}>
        ...
        Schoolyard uses ‘cookies’. These cookies are used to store information
      ...
      <Heading my={2} fontSize="20px">Disclaimers</Heading>
      ...
      <Heading my={2} fontSize="20px">Limitation on Liability</Heading>
      ...
      <Heading my={2} fontSize="20px">Copyright Policy.</Heading>
      ...
      <Heading my={2} fontSize="20px">General</Heading>
      ...
      <Text my={2}>
        ...
        the Company should be sent to: New York, New York. After the Notice is
      ...
      <Heading my={2} fontSize="20px">Contact Information</Heading>

      <Text my={2}>Address: New York, New York</Text>
      <Text my={2}>Email: schoolyardinfo@gmail.com</Text>
    </>
  );
};
